...
class DataAPIHttpClient extends api_1.HttpClient {
    constructor(props, embeddingApiKey) {
    ...
    forCollection(namespace, collection, opts) {
        const clone = new DataAPIHttpClient(__classPrivateFieldGet(this, _DataAPIHttpClient_props, "f"), opts?.embeddingApiKey);
...
function mkHeaders(embeddingApiKey) {
    if (embeddingApiKey) {
        return (token) => ({
            [api_1.DEFAULT_EMBEDDING_API_KEY_HEADER]: embeddingApiKey,
